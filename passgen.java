...
public static final String ANSI_RED = "\u001B[31m";
    public static void main(String args[])throws FileNotFoundException 
    {
        ...
        System.out.println("Simply enter the credentials that you think could be the password of the person followed by a semicoln (;) ");
        ...
        System.out.println("Do you want to print it? (Y/N)");
        char check=sc.next().charAt(0);
		if(check=='y'||check=='Y')
        {
            crack(arr, l);
        }
        System.out.println("Thanks for using Passgen !");
}
